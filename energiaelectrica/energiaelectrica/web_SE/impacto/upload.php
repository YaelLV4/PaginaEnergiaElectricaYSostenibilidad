        ...
        <section id="content">
            ...
            <div class="content-wrap">
                ...
                <div class="container clearfix">
                    ...
                    <div class="login-materia">

                        <div class="card">
                            <div class="card-header" style="background: #cd171e; color: white; font-weight: bold;">Subir archivos</div>
                            <div class="card-body">
                                <form enctype="multipart/form-data" class="nobottommargin" method="post" action="upload_file.php">
                                    ...
                                    <input class="btn" style="background: #cd171e; color: white; font-weight: bold;" type="submit" name="subir" value="Subir archivo">
                                    <?php
                                        echo $msg_err;
                                    ?>
                                </form>
