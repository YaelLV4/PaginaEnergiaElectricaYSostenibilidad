...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
                ...
                <nav id="primary-menu" class="style-2 center">
                    ...
                    <div class="container clearfix">
                        ...
                        <ul>
                            ...
                            <li class="current"><a href="http://odin.fi-b.unam.mx/senergeticos"><div>Sistemas energéticos</div></a></li>
                        </ul>
        ...
        <section id="page-title">
            ...
            <div class="container clearfix">
                <h1>Energía e impacto ambiental</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="http://www.ingenieria.unam.mx/">Nuestra Facultad</a></li>
                    <li class="breadcrumb-item active"><a href="http://odin.fi-b.unam.mx/paeunam/">Proyectos de ahorro de energía</a></li>
                </ol>
            </div>
        ...
        <section id="content">
            ...
            <div class="content-wrap">
                ...
                <div class="container clearfix">
                    ...
                    <div class="login-materia" style="margin-top: 100px; margin-bottom: 100px">

                        <div class="card">
                            <div class="card-header" style="background: #cd171e; color: white; font-weight: bold;">Login</div>
                            <div class="card-body">
                                <form class="nobottommargin" method="post" action="usuarios.php">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="usuario" placeholder="usuario" pattern="[a-zA-Z0-9]+">
                                    </div>
                                    <div class="form-group">                                                
                                        <input class="form-control" type="password" name="pass" placeholder="contraseña" pattern="[a-z0-9]+">
                                    </div>
                                    <input class="btn" style="background: #cd171e; color: white; font-weight: bold;" type="submit" name="acceder" value="acceder">
                                    <?php
                                        echo $msg_err;
                                    ?>
                                </form>
